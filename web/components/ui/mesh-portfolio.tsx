...
//
// Palette retuned to Saku's warm set: cream base, soft gold, saku-yellow
// (#FFD362), saku-orange (#F0A353). It stays light enough for black type.
...
const UNIFORMS = {
  colors: [
    ...
    [1.0, 0.82745, 0.38431],        // #FFD362 saku-yellow
    [0.94118, 0.63922, 0.32549],    // #F0A353 saku-orange
    [0.94118, 0.63922, 0.32549],
    [0.94118, 0.63922, 0.32549],
    [0.94118, 0.63922, 0.32549],
    [0.94118, 0.63922, 0.32549],
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      // A hoisted declaration drops the narrowing the effect body already did,
      // so re-assert it here rather than sprinkling non-null assertions below.
      if (!canvas || !gl) return
