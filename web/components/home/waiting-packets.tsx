  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 font-sans space-y-3">
      <div className="flex items-end justify-between px-1">
        ...
        <p className="text-[11px] font-medium text-black/35 pb-1">
          Fastest finger
        </p>
      </div>
        ...
        {packets.slice(0, 3).map((packet, index) => {
          ...
          return (
            <motion.button
              ...
              className="group w-full rounded-3xl bg-white border border-black/[0.06] p-3.5 text-left overflow-hidden transition-colors hover:border-black/15"
            >
              <div className="flex items-center gap-3">
                <div
                  className="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 text-white shadow-[inset_0_0_0_1px_rgb(255_255_255/0.18)]"
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-semibold tracking-tight truncate flex items-center gap-1.5">
