 ...
 */
const SCOPED_KEYS = [PHONE_KEY, BANK_KEY, 'saku_contact_numbers'] as const;
 ...
 * saved bank account numbers, and the contact list's cached numbers — the plain values the server
 * deliberately never stores, sitting in `localStorage` until the browser was wiped. Scoping them
